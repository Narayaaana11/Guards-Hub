...
import logoDark from "../../assets/images/watch-dogs-1-logo.png";
import logoLight from "../../assets/images/watch-dogs-1-logo.png";
          ...
          <Row className="justify-content-center">
            <Col md={8} lg={6} xl={5}>
                ...
                <CardBody className="pt-0">
                  ...
                  <h3 className="text-center mt-5 mb-4">
                    <Link to="/" className="d-block auth-logo">
                      ...
                      <img src={logoLight} alt="" height="120" className="auth-logo-light" />
                    </Link>
                  </h3>
              ...
              <div className="mt-5 text-center">
                ...
                © {new Date().getFullYear()} Watch Dogs <span className="d-none d-sm-inline-block"> - Crafted with <i className="mdi mdi-heart text-danger"></i> by Technical Hub.</span>
              </div>
            </Col>
          </Row>
        </Container>
