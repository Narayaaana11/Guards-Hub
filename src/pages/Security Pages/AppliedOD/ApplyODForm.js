...
const ApplyODForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isFormValid) {
      console.log("OD Form submission failed due to invalid fields:", validation);
    ...
    try {
      setSubmitting(true);
      const response = await axios.post(`${BASE_URL}/od/apply`, payload);
  ...
  return (
    <div>
      ...
      {selectedEmployee && (
        <Card>
          <StyledCardBody>
            <CardTitle className="h5">Apply OD</CardTitle>
            <Row className="mb-4">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <FormGroup>
                ...
                <textarea
                  ...
                  maxLength="225"
                  placeholder="Enter reason for OD (min 10 chars)"
                  disabled={submitting}
                />
